...
local module = Cryolysis3:NewModule("HUNTER", Cryolysis3.ModuleCore, "AceEvent-3.0")
...
function module:OnEnable()
	...
	local t = {
		"ClassSpell.Hunter.Beast Mastery",
		"ClassSpell.Hunter.Marksmanship",
		"ClassSpell.Hunter.Survival"
	};
