...
local module = Cryolysis3:NewModule("WARRIOR", Cryolysis3.ModuleCore, "AceEvent-3.0")
...
function module:OnEnable()
	...
	local t = {
		"ClassSpell.Warrior.Arms",
		"ClassSpell.Warrior.Fury",
		"ClassSpell.Warrior.Protection"
	};
...
function module:RegisterClassEvents()
	...
	module:RegisterEvent("UNIT_RAGE");
end

------------------------------------------------------------------------------------------------------
-- Rawr, we ish big ferooshus worrier!
------------------------------------------------------------------------------------------------------
function module:UNIT_RAGE(event, unitId)
